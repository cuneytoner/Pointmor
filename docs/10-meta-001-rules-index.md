...
**Güncel ürün:** **Pointmor** — **modüler çok kiracılı platform**; çekirdek kod `apps/api` + `apps/admin-web`. Core platform (tenant, membership, auth/session, plan/abonelik) ortaktır; işlevler modüllerle sunulur.
...
| Core platform doktrini (tenant, membership, module, advisor, isolation) | [`10-meta-004-core-platform-definition.md`](./10-meta-004-core-platform-definition.md) |
...
| Platform modüler mimari (core vs module, aktivasyon) | [`20-rules-013-platform-modules.md`](./20-rules-013-platform-modules.md) |
| Advisor–client üyelik modeli | [`20-rules-014-advisor-client-model.md`](./20-rules-014-advisor-client-model.md) |
| Cross-tenant erişim güvenliği (advisor dahil) | [`20-rules-015-cross-tenant-access-security.md`](./20-rules-015-cross-tenant-access-security.md) |
...
| AI Act Compliance modül spec’i | [`30-spec-001-ai-act-module.md`](./30-spec-001-ai-act-module.md) |
| Ürün shell’leri ve branding spec’i | [`30-spec-002-product-shells-and-branding.md`](./30-spec-002-product-shells-and-branding.md) |
...
| Meta (core doctrine) | `10-meta-004-core-platform-definition.md` |
| Kurallar | `20-rules-001` … `20-rules-015` |
| Spec | `30-spec-001-ai-act-module.md`, `30-spec-002-product-shells-and-branding.md` |
