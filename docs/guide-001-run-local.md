...
| `npm.cmd run db:seed` | Örnek kiracı / kullanıcı / plan. Senaryo başına kullanıcı ve şifreler: [`ref-001-dev-seed-users.md`](./ref-001-dev-seed-users.md). `prisma.config.ts` içinde seed komutu tanımlı. |
