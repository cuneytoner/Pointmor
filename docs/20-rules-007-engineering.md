...
- **Asla loglama:** Şifre, token, tam kart, ham PII (ayrıntı [20-rules-005-security.md](./20-rules-005-security.md)).
...
- **Yerel DB + asistan migrate adımları**: [40-guide-001-run-local.md](./40-guide-001-run-local.md#prisma-migrate-after-schema).
- **CI, deploy, migration çalıştırma**: [20-rules-006-deployment-and-ops.md](./20-rules-006-deployment-and-ops.md).
- **Güvenlik DoD ve log/PII**: [20-rules-005-security.md](./20-rules-005-security.md).
- **i18n DoD (metin, anahtar)**: [20-rules-010-i18n.md](./20-rules-010-i18n.md).
