/** Plus Admin tarzı nav için basit SVG ikonlar (dummy). */
...
export function IconDashboard(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M4 13h6V4H4v9zm10 7h6v-7h-6v7zM4 20h6v-5H4v5zm10-13h6V4h-6v3z" />
    </svg>
  );
}
...
/** Veri kataloğu / yönetişim — katmanlı kayıt */
...
export function IconDataHealth(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      width="20"
      height="20"
      ...
      {...props}
    >
      <path d="M4.5 12.5c2.5 3 6 4.5 7.5 4.5s5-1.5 7.5-4.5" />
      <path d="M12 3c-4 4-6 7-6 10a6 6 0 1012 0c0-3-2-6-6-10z" />
    </svg>
  );
}
